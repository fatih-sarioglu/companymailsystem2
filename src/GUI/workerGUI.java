...
public class workerGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try{
            ...
            for (int i = 0; i < worker.getMailList(worker.getId()).size(); i++){
                switch(worker.getMailList(worker.getId()).get(i).getMailBox()){
                    case "1":
                    inboxData[0] = worker.getMailList(worker.getId()).get(i).getMailTime();
                    inboxData[1] = worker.getMailList(worker.getId()).get(i).getMailFrom();
                    inboxData[2] = worker.getMailList(worker.getId()).get(i).getMailSubject();
                    inboxModel.addRow(inboxData);
                    break;
                    case "2":
                    spamData[0] = worker.getMailList(worker.getId()).get(i).getMailTime();
                    spamData[1] = worker.getMailList(worker.getId()).get(i).getMailFrom();
                    spamData[2] = worker.getMailList(worker.getId()).get(i).getMailSubject();
                    spamModel.addRow(spamData);
                    break;
                    case "3":
                    archData[0] = worker.getMailList(worker.getId()).get(i).getMailTime();
                    archData[1] = worker.getMailList(worker.getId()).get(i).getMailFrom();
                    archData[2] = worker.getMailList(worker.getId()).get(i).getMailSubject();
                    archModel.addRow(archData);
                    break;
                    case "4":
                    trashData[0] = worker.getMailList(worker.getId()).get(i).getMailTime();
                    trashData[1] = worker.getMailList(worker.getId()).get(i).getMailFrom();
                    trashData[2] = worker.getMailList(worker.getId()).get(i).getMailSubject();
                    trashModel.addRow(trashData);
                    break;
                    case "5":
                    sentData[0] = worker.getMailList(worker.getId()).get(i).getMailTime();
                    sentData[1] = worker.getMailList(worker.getId()).get(i).getMailTo();
                    sentData[2] = worker.getMailList(worker.getId()).get(i).getMailSubject();
        ...
        contentPane.setPreferredSize(new java.awt.Dimension(500, 600));
        ...
        byte[] bytes = worker.getName().getBytes(StandardCharsets.UTF_8);
        ...
        spamItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e10){
                try{
                    ...
                    String query = String.format("UPDATE users_mails.%dmails SET mail_box = '2' WHERE mail_subject ='" + selSub + "'",worker.getId());
        ...
        archItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e10){
                try{
                    ...
                    Statement st = con.createStatement();
                    inboxModel.removeRow(inboxTable.getSelectedRow());
                    String query = String.format("UPDATE users_mails.%dmails SET mail_box = '3' WHERE mail_subject ='" + selSub + "'",worker.getId());
                    st.executeUpdate(query);
                } catch(SQLException e2){
                    e2.printStackTrace();
                } catch(Exception e){
        ...
        trashItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e10){
                try{
                    ...
                    Statement st = con.createStatement();
                    inboxModel.removeRow(inboxTable.getSelectedRow());
                    String query = String.format("UPDATE users_mails.%dmails SET mail_box = '4' WHERE mail_subject ='" + selSub + "'",worker.getId());
                    st.executeUpdate(query);
                } catch(SQLException e2){
                    e2.printStackTrace();
                } catch(Exception e){
        ...
        openItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e10){
                try{
                    ...
                    Connection con = conn.connDb();
                    Statement st = con.createStatement();
                    String query = String.format("SELECT mail_content FROM users_mails.%dmails WHERE mail_subject ='" + selSub + "'",worker.getId());
        ...
        JMenuItem sOpenItem = new JMenuItem("Open mail");
        spamMenu.add(sOpenItem);
        ...
        sInboxItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e10){
                try{
                    ...
                    String query = String.format("UPDATE users_mails.%dmails SET mail_box = '1' WHERE mail_subject ='" + selSub + "'",worker.getId());
                    st.executeUpdate(query);
                } catch(SQLException e2){
                    e2.printStackTrace();
                } catch(Exception e){
        ...
        sOpenItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e10){
                try{
                    String selDate = spamTable.getValueAt(spamTable.getSelectedRow(),0).toString();
                    String selEmail = spamTable.getValueAt(spamTable.getSelectedRow(), 1).toString();
                    String selSub = spamTable.getValueAt(spamTable.getSelectedRow(), 2).toString();
                    JFrame mailFrame = new JFrame(selSub);
                    mailFrame.setVisible(true);
                    mailFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ...
        JMenuItem aOpenItem = new JMenuItem("Open mail");
        archMenu.add(aOpenItem);
        ...
        aOpenItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e10){
                try{
                    String selDate = archTable.getValueAt(archTable.getSelectedRow(),0).toString();
                    String selEmail = archTable.getValueAt(archTable.getSelectedRow(), 1).toString();
                    String selSub = archTable.getValueAt(archTable.getSelectedRow(), 2).toString();
                    JFrame mailFrame = new JFrame(selSub);
                    mailFrame.setVisible(true);
                    mailFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ...
        JMenuItem tOpenItem = new JMenuItem("Open mail");
        ...
        tDeletePerm.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e10){
                try{
                    ...
                    Statement st = con.createStatement();
                    trashModel.removeRow(trashTable.getSelectedRow());
                    String query = String.format("DELETE FROM users_mails.%dmails WHERE mail_subject ='" + selSub + "'",worker.getId());
                    st.executeUpdate(query);
                } catch(SQLException e2){
                    e2.printStackTrace();
                } catch(Exception e){
        ...
        tOpenItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e10){
                try{
                    String selDate = trashTable.getValueAt(trashTable.getSelectedRow(),0).toString();
                    String selEmail = trashTable.getValueAt(trashTable.getSelectedRow(), 1).toString();
                    String selSub = trashTable.getValueAt(trashTable.getSelectedRow(), 2).toString();
                    JFrame mailFrame = new JFrame(selSub);
                    mailFrame.setVisible(true);
                    mailFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    sendButton.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            try{
                ...
                String query3 = String.format("INSERT INTO users_mails.%smails (mail_to,mail_from,mail_subject,mail_content,mail_time,mail_box) VALUES (?,?,?,?,?,?)", worker.getId());
                PreparedStatement ps2 = con.prepareStatement(query3);
                ps2.setString(1, toMail);
                ps2.setString(2, worker.getAddress());
    ...
    */
    ...
    layout.setVerticalGroup(
        layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addComponent(contentPane, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 600, javax.swing.GroupLayout.PREFERRED_SIZE)
    );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new workerGUI(worker).setVisible(true);
            }
        });
    }
